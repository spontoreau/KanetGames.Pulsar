...
namespace Gwen.Control
{
    ...
    public class TextBox : Label
    {
        ...
        protected override bool OnKeyReturn(bool down)
        {
            ...
            //OnKeyTab(true); MAJ SPO 27/08/2013 no need to go to next control on submit...

            // If we still have focus, blur it. 
            //if (HasFocus) MAJ SPO 27/08/2013 why blur the control ? If user call Focus() in the submit handler it's doesn't work :(
            //{
            //    Blur();
            //}
